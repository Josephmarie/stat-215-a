...
results.to_csv('grid_search_results_red_model.csv', index=False)
...
results_parameter.to_csv('results_parameter_red.csv', index=False)

# Save the best model
best_rf = grid_search.best_estimator_
joblib.dump(best_rf, 'best_random_forest_model_reduc.pkl')